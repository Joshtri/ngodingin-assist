...
export const productItems: ProductItem[] = [
  {
    ...
    description:
      "Aplikasi yang membantu pengambilan keputusan kompleks dengan metode perhitungan seperti SAW, TOPSIS, AHP, atau kombinasi beberapa metode.",
    icon: ChartBarIcon,
    examples: [
      "SPK Pemberian Beasiswa",
      "SPK Rumah Layak Huni",
      "SPK Pembebasan Bersyarat",
      "SPK Penerima Bantuan Sosial",
    ],
    image: "/assets/product/spk.webp",
  },
  {
    title: "Sistem Informasi Manajemen",
    description:
      "Aplikasi pengelolaan data dan proses bisnis untuk meningkatkan efisiensi organisasi dengan pelaporan dan dashboard terintegrasi.",
    icon: DocumentTextIcon,
    examples: [
    ...
    image: "/assets/product/sim.webp",
  },
  {
    title: "Aplikasi Web Pembelajaran",
    description:
      "Platform e-learning yang memungkinkan akses materi pembelajaran, video, kuis interaktif, dan diskusi online.",
    icon: GlobeAltIcon,
    examples: [
      "E-Learning Sekolah/Kampus",
      "Portal Pembelajaran Daring",
      "Sistem Ujian Online",
      "Platform Kursus Digital",
    ],
    image: "/assets/product/e-learning.webp",
  },

  {
    title: "Web API dan Backend Services",
    description:
      "Layanan backend dan API yang handal untuk mendukung aplikasi web dan mobile dengan performa tinggi dan skalabilitas baik.",
    icon: ServerIcon,
    examples: [
      "API Gateway",
      "Mikroservis",
    ...
    image: "/assets/product/api-backend.webp",
  },
];
